...
When an override exists, the app marks that weapon as `Source: ingame override` in the raw-stats inspector and shows those values exactly as an in-game snapshot.
